#!/usr/bin/env bash
#SBATCH --job-name=b73mo17_dec_C0_nd
...
#SBATCH --array=0-1
#SBATCH --output=_logs/04_06_decontam_B73Mo17_C0_nd_%A_%a.log
#
# 04_06_decontam_B73Mo17_C0_nd.sh — B73Mo17 rep1+rep2 decontam (without_design)
#                                   on C0 (4cfg_2026-05-01) cells_calls.
#
# Array layout:
#   task 0 : B73Mo17_rep1 (64,111 chunks, 6.4M BCs)  -> ~36h projected
#   task 1 : B73Mo17_rep2 (55,539 chunks, 5.5M BCs)  -> ~31h projected
# (Rate basis: SM2v2 single-mode ran ~1,785 chunks/h at 10 cpus.)
#
# Resource budget: 48h/40G/10cpu per task — matches SM2v2 split-script budget
# (which finished comfortably). Memory headroom over SM2v2 because 2-genome
# panel is lean.
#
# Output: <sample>/decontam_without_design_alpha05_C0/ (reads_to_drop -> 04_07
#         clean-bams -> WASP and purity chain, Fig. 4L to N; *_decontam_params.json
#         -> Table S1).
# =============================================================================
...
samples=(B73Mo17_rep1 B73Mo17_rep2)
...
echo "============================================================"
echo "[$(date)] B73Mo17 decontam (C0, without_design) — task $SLURM_ARRAY_TASK_ID"
echo "  sample      : $sample"
echo "  cells_calls : $cells_calls"
echo "  assign_glob : $assign_glob"
echo "  walltime    : 48:00:00, mem=40G, threads=$threads"
echo "============================================================"
