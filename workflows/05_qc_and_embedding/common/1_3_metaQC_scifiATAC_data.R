###############################################################################
## 1_3_metaQC_scifiATAC_data.R -- Step 1_3: meta-QC cascade on the 1_2 metadata (one library, one depth floor)
...
## Usage: Rscript 1_3_metaQC_scifiATAC_data.R <prefix>.updated_metadata.txt <prefix> <depth_filter>
...
if (length(args) != 3) {
  stop("Usage: Rscript 1_3_metaQC_scifiATAC_data.R <input> <name> <depth_filter>\n",
