###############################################################################
## 1_2_filter_lowQC_cells_scifiATAC_data.R -- Step 1_2: per-barcode QC statistics and reference-based cell call
...
## Usage: Rscript 1_2_filter_lowQC_cells_scifiATAC_data.R <prefix>.raw.soc.rds <prefix>
## Called by common/1_2_1_3_run.sh and part2_split/step0_qc/1_QC_scifiATAC_SM2v2_plate.sh.
###############################################################################
...
if (length(args) != 2) {
  stop("Usage: Rscript 1_2_filter_lowQC_cells_scifiATAC_data.R <input.rds> <prefix>")
}
