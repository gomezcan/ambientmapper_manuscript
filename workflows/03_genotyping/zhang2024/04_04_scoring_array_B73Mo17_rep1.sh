#!/usr/bin/env bash
#SBATCH --job-name=b73mo17r1_score
...
#SBATCH --array=0-3
#SBATCH --output=_logs/04_04_b73mo17r1_score_%A_%a.log
#
# 04_04_scoring_array_B73Mo17_rep1.sh
#
# SLURM array scoring for B73Mo17_rep1 using --score-chunk-range.
# 4 tasks each process ~16K chunks in parallel (64K total, ~18.7K remaining).
# 2-genome dataset — lighter than multiGenotypes, defaults are fine.
# Expected wall: ~6.5h per task at ~5s/chunk.
#
...
# a timed-out run, delete the partially written *_filtered.tsv.gz / *_raw.tsv.gz
# files written after the timeout first.
#
# =============================================================================
...
CONFIG="configs/B73Mo17_rep1.ambientmapper.json"
SAMPLE="B73Mo17_rep1"
THREADS=16
N_TASKS=4
...
echo "============================================================"
echo "[$(date)] Score array: B73Mo17_rep1"
...
echo "  batch_size=200 (default), workers=4 (default)"
echo "============================================================"
